        ...
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                if (!isuploadTextureImage) {
                    ...
                    TextureUtil.uploadTextureImage(textureID, TextureManager.getBufferedImage(url));
                    isuploadTextureImage = true;
                }
                GlStateManager.bindTexture(textureID);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                GuiUtil.drawModalRectWithCustomSizedTexture(xPosition, yPosition, textureX, textureY, width, height, textureWidth, textureHeight);
            }
