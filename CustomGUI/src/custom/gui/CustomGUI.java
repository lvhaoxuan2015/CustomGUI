        ...
        if (sender.isOp()) {
            ...
            if (args.length == 2) {
                ...
                if (p != null) {
                    ...
                    nwg.objList.add(new NetWorkGuiUrlGif("https://n.sinaimg.cn/tech/transform/523/w299h224/20190130/IMDE-hshmsti2178231.gif", NetWorkGuiManager.distributeID(), 5, 240, 0, 0, 0, 121, 121));
                    nwg.objList.add(new NetWorkGuiText("§a§l薄荷在窗边打飞机！！！！！！！！！！！！！！！！！", NetWorkGuiManager.distributeID(), 0, 0, 0xFF3030));
                    ...
                    nwg.objList.add(new NetWorkGuiText("我作证！", NetWorkGuiManager.distributeID(), 50, 10, 0xFF3030));
