...
public final class JavaVersion {
	...
	// However, many alternate implementations differ. For example, Debian used
	// 9-debian as the version string
	...
	/**
	 * @return {@code true} if the application is running on Java 9 or later; and
