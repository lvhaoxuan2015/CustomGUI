...
/**
 * Provides a replacement for {@link AccessibleObject#setAccessible(boolean)},
 * which may be used to avoid reflective access issues appeared in Java 9, like
 * {@link java.lang.reflect.InaccessibleObjectException} thrown or warnings like
 * 
 * <pre>
...
public abstract class ReflectionAccessor {
	 ...
	 * {@link java.lang.reflect.InaccessibleObjectException}. In such a case, use
	 * {@link ReflectionAccessor#makeAccessible(AccessibleObject)} on a field,
	 * method or constructor (instead of basic
